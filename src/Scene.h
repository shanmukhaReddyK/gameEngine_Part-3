...
class Scene {
  ...
  void doAction(const Action&); //TODO: check if const Action& is the right way or we have to use smart pointers or just Action
  void registerAction(const Action&); //TODO: check if const Action& is the right way or we have to use samrt pointers or just Action
